...
def closer_city(lat, lon, city1, city2):
    ...
    return get_name(min(city1, city2, key = lambda city: distance(temp_city, city)))
...
def nut_finder(t):
    ...
    if label(t) == 'nut': return True
        ...
        for branch in branches(t):
            if nut_finder(branch): return True
        return False
...
def sprout_leaves(t, values):
    ...
    """
    "*** YOUR CODE HERE ***"
    if is_leaf(t): return tree(label(t), [tree(i) for i in values])
    else:
